...
type Service = { num: string; title: string; desc: string; output: string };
    ...
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {services.map((service, i) => (
        <Reveal key={service.num} index={i}>
          <div className="group h-full rounded-lg border border-navy/[0.08] bg-white p-8 transition-all duration-250 ease-out hover:-translate-y-1 hover:border-green hover:bg-[#f5fbf6] hover:shadow-[0_12px_28px_rgba(13,24,38,0.1)]">
